...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // if everything is ok, try to upload file
       ...
       //$picture = "./".$_POST["category"]."/" . $imageName;
        $path = "../eyecare/". $imageName;
        //header("Location: insertItemAdmin.php");
        //add to database here
        $q = "INSERT INTO items (itemName, category, code, picture, info, price, promotion) VALUES ('$i', 'eyecare', '$c', '$path', '$in', '$p', '$pro')";
...
<div class="div" style="height: 12vh;">
    ...
    <form action="eyecare.php" method="post" enctype="multipart/form-data">
...
// Define the query:
$q = "SELECT id, itemName, code, price, category, info, promotion, registration_date FROM items WHERE category='eyecare' ORDER BY $order_by LIMIT $start, $display";		
...
<tr style="background-color: #00cc00;">
	...
	<td align="left"><b><a href="eyecare.php?sort=iN">Item Name</a></b></td>
    <td align="left"><b><a href="eyecare.php?sort=cod">Code</a></b></td>
    <td align="left"><b><a href="eyecare.php?sort=cat">Category</a></b></td>
    <td align="left"><b><a href="eyecare.php?sort=pri">Price</a></b></td>
    <td align="left"><b>Description</b></td>
    <td align="left"><b><a href="eyecare.php?sort=pro">Promotion</a></b></td>
    <td align="left"><b><a href="eyecare.php?sort=rd">Date Registered</a></b></td>
</tr>
';
//<b><a href="eyecare.php?sort=ln">Last Name</a>/b>
...
if ($pages > 1) {
	...
	if ($current_page != 1) {
		echo '<a href="eyecare.php?s=' . ($start - $display) . '&p=' . $pages . '&sort=' . $sort . '">Previous</a> ';
	}
	
	// Make all the numbered pages:
	for ($i = 1; $i <= $pages; $i++) {
		if ($i != $current_page) {
			echo '<a href="eyecare.php?s=' . (($display * ($i - 1))) . '&p=' . $pages . '&sort=' . $sort . '">' . $i . '</a> ';
		} else {
			echo $i . ' ';
		}
	} // End of FOR loop.
	...
	if ($current_page != $pages) {
		echo '<a href="eyecare.php?s=' . ($start + $display) . '&p=' . $pages . '&sort=' . $sort . '">Next</a>';
	}

...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // if everything is ok, try to upload file
       ...
       //$picture = "./".$_POST["category"]."/" . $imageName;
        $path = "../contactLens/". $imageName;
        //header("Location: insertItemAdmin.php");
        //add to database here
        $q = "INSERT INTO items (itemName, category, code, picture, info, price, promotion) VALUES ('$i', 'contactLens', '$c', '$path', '$in', '$p', '$pro')";
...
<div class="div" style="height: 12vh;">
    ...
    <div class="divNav" style="width:100vw; background-color: black;">
        ...
        <div class="inDiv" style="width:100vw; background-color: black;">
            ...
            <nav class="nav" style="margin: auto;">   
                ...
                <b><a href="contactLens.php" class="active hyperlinks">Contact Lens</a></b>
    ...
    <form action="contactLens.php" method="post" enctype="multipart/form-data">
  ...
  <input type="submit" value="Upload Item" name="submit">
    ...
    <h1 style="text-align: center;">Contact Lens</h1>
...
// Define the query:
$q = "SELECT id, itemName, code, price, category, info, promotion, registration_date FROM items WHERE category='contactLens' ORDER BY $order_by LIMIT $start, $display";		
...
<tr style="background-color: #00cc00;">
	...
	<td align="left"><b><a href="contactLens.php?sort=iN">Item Name</a></b></td>
    <td align="left"><b><a href="contactLens.php?sort=cod">Code</a></b></td>
    <td align="left"><b><a href="contactLens.php?sort=cat">Category</a></b></td>
    <td align="left"><b><a href="contactLens.php?sort=pri">Price</a></b></td>
    <td align="left"><b>Description</b></td>
    <td align="left"><b><a href="contactLens.php?sort=pro">Promotion</a></b></td>
    <td align="left"><b><a href="contactLens.php?sort=rd">Date Registered</a></b></td>
</tr>
';
//<b><a href="contactLens.php?sort=ln">Last Name</a>/b>

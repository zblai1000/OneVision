...
input[type=submit]:hover {
  ...
  <body>
    ...
    <div id="mySidenav" class="sidenav">
        <br>
        <br>
        <b><a href="home.php" class="active">Home</a></b>
    ...
    <div class="divNav" style="width:100vw; background-color: black;">
        ...
        <div class="inDiv" style="width:100vw; background-color: black;">
            ...
            <nav class="nav" style="margin: auto;">   
                <b><a href="home.php" class="active hyperlinks">Home</a></b>
    ...
    <img src="./Pictures/homeMain.jpg" alt="home" style="width: 100vw; height: auto;">
    ...
    <div>
        <h1 style="text-align: center;">Welcome to OneVision!</h1>
  
        <h2 style="text-align: center;">Where vision meets mission.</h2>
    </div>
...
<?php
$product_array = $db_handle->runQuery("SELECT * FROM items WHERE promotion = 'yes' ORDER BY id ASC");
...
<div class="productDiv">
    ...
    <div class="productDiv">
    <p style="font-weight: bold;"><a href="contactLensView.php?id=<?php echo $product_array[$key]["id"];  ?>" style="text-decoration: none; color: black;"><?php echo $product_array[$key]["itemName"]; ?></a></p>
        <p><?php echo "RM ".$product_array[$key]["price"]; ?></p>
        <p><input type="text" name="quantity" value="1" size="2" style="width: 4em; margin: 3px;" /><input type="submit" value="Add to cart" class="btnAddAction" /></p>
    </div>
    </form>
</div>
<?php

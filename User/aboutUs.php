...
<html>
  ...
  <body>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <b><a href="aboutUs.php" class="active">About Us</a></b>
    ...
    <div class="divNav" style="width:100vw; background-color: black;">
        ...
        <div class="inDiv" style="width:100vw; background-color: black;">
            ...
            <nav class="nav" style="margin: auto;">   
                ...
                <b><a href="aboutUs.php" class="active hyperlinks">About Us</a></b>
    ...
    <img src="./Pictures/aboutUsMain.jpg" alt="home" style="width: 100vw; height: auto;">
    ...
    <div style="text-align: center;">
        <h2>Who are we?</h2>
        <h3>We are OneVision, a start-up at Kuala Lumpur, Malaysia that designs and craft eyewear.</h3>
    ...
    <div style="text-align: center;">
        ...
        <h3>We aim to directly supply consumers eyewear products by eliminating the middleman and any physical store operational costs. This allows us to sell our high-end quality eyewear at a lower than market rate price.</h3>
    </div>

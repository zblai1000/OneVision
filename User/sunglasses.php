...
background-color: #45a049;
  ...
  <body>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <b><a href="sunglasses.php" class="active">Sunglasses</a></b>
    ...
    <img src="./Pictures/sunglassesMain.jpg" alt="home" style="width: 100vw; height: auto;">
    ...
    <div class="div" style="flex-wrap: wrap; justify-content: center;">
        ...
        <?php
        $product_array = $db_handle->runQuery("SELECT * FROM items WHERE category = 'sunglasses' ORDER BY id ASC");
        ...
        <div class="productDiv">
            ...
            <div class="productDiv">
            <p style="font-weight: bold;"><a href="sunglassesView.php?id=<?php echo $product_array[$key]["id"];  ?> "style="text-decoration: none; color: black;"><?php echo $product_array[$key]["itemName"];  ?></a></p>

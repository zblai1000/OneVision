...
<html>
  ...
  <body>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <b><a href="contactUs.php" class="active">Contact Us</a></b>
    ...
    <div class="divNav" style="width:100vw; background-color: black;">
        ...
        <div class="inDiv" style="width:100vw; background-color: black;">
            ...
            <nav class="nav" style="margin: auto;">   
                ...
                <b><a href="contactUs.php" class="active hyperlinks">Contact Us</a></b>
    ...
    <img src="./Pictures/contactUsMain.jpg" alt="home" style="width: 100vw; height: auto;">
    ...
    <div style="text-align: center;">
        <button class="button"><a href="contactForm.php" style=" text-decoration: none; color: white;">Form to contact us</a></button>
    </div>

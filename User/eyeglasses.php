...
input[type=submit]:hover {
  ...
  <body>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <b><a href="eyeglasses.php" class="active">Eyeglasses</a></b>
    ...
    <img src="./Pictures/eyeglassesMain.jpg" alt="home" style="width: 100vw; height: auto;">
    ...
    <div class="div" style="flex-wrap: wrap; justify-content: center;">
        ...
        <?php
        $product_array = $db_handle->runQuery("SELECT * FROM items WHERE category = 'eyeglasses' ORDER BY id ASC");
        if (!empty($product_array)) { 
            foreach($product_array as $key=>$value){
        ?>

        <div class="productDiv">
            <form method="post" action="eyeglasses.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
            ...
            <div class="productDiv">
                <p style="font-weight: bold;"><a href="eyeglassesView.php?id=<?php echo $product_array[$key]["id"];  ?>" style="text-decoration: none; color: black;"><?php echo $product_array[$key]["itemName"]; ?></a></p>

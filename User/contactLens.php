...
input[type=submit]:hover {
  ...
  <body>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <b><a href="contactLens.php" class="active">Contact Lens</a></b>
    ...
    <img src="./Pictures/contactLensMain.jpg" alt="home" style="width: 100vw; height: auto;">
    ...
    <div class="div" style="flex-wrap: wrap; justify-content: center;">
        ...
        <?php
        //store product under category of contact lens in the array
        $product_array = $db_handle->runQuery("SELECT * FROM items WHERE category = 'contactLens' ORDER BY id ASC");
        if (!empty($product_array)) { 
            //display each element in the array that consist of the key of that instance 
